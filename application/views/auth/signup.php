...
<body>
	<section id="main" style= "background-image:url('../assets/images/kamui.jpg'); background-size: cover;">
		<div id="" class="container form_container">
			<div class="row form_row">
				<div class="col-lg-4 bg-white px-4 py-4" id="form_col">
					<form autocomplete="off" id="form_signup" enctype="multipart/form-data">
						<h3 class="text-center">Buat Akun Dichat</h3>
						...
						<div class="field_container">
							<div class="row">
								<div class="form-group col-lg-6">
									<input type="text" name="txt_fname" id="fname" placeholder="Nama Pertama" class="form-control">
								</div>
								<div class="form-group col-lg-6">
									<input type="text" name="txt_lname" id="lname" placeholder="Nama Akhir" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								<button class="btn btn-block" style="background-color:#ea675d; border-radius:20px;" id="btn_signup">
									<span>Signup</span>
								</button>
							</div>
							<h6 class="text-center">Sudah Ada Akun? <a href="<?php echo base_url();?>" style="text-decoration:none;">Login</a></h6>
						</div>
