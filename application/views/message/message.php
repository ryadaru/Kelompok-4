	...
	<section id="main" class="bg-dark">
		...
		<div id="chatbox">
			<div id="data_container" class="">
				<div id="bg_image"></div>
				<h2 class="mt-0">Halo Selamat Datang Di</h2>
				<h2>Dischat</h2>
			</div>
	...
	<div id="update_container">
		...
		<form class="" id="form_details" autocomplete="off">
			...
			<div class="form-group">
				...
				<input type="text" maxlength="10" name="txt_phone" placeholder="Tulis Nomor" id="phone_num" class="form-control">
			</div>
			<div class="form-group">
				<label>Address</label>
				<input type="text" name="txt_addr" id="address" placeholder="Tulis Alamat" class="form-control">
			</div>
			<div class="form-group">
				<label>Bio</label>
				<textarea name="bio" class="" id="update_bio" placeholder="Tulis Bio"></textarea>
			</div>
